...
- (void)templateBigTopSplitBottom:(NSInteger)index style:(NSUInteger)tempStyle {
  ...
  NSString *baseHeadline = [NSString stringWithFormat:@"headline%d",(int)index+1];
  NSString *baseBlurb = [NSString stringWithFormat:@"blurb%d",(int)index+1];
  NSString *baseImage = [NSString stringWithFormat:@"image%d",(int)index+1];
  NSString *baseByline = [NSString stringWithFormat:@"byline%d",(int)index+1];
